...
class TeamSpec {
  ...
  fun `when a create team command is received, a team is created`() {
    fixture
      ...
      .`when`(CreateTeam(id = "4711", name = "Muppet Team", team = Team(UserName("kermit"), UserName("piggy")), imageUrl=""))
      .expectEvents(TeamCreated(id = "4711", name = "Muppet Team", team = Team(UserName("kermit"), UserName("piggy")), imageUrl = ""))
  }
  ...
  fun `when a create team without players command is received, a team is created`() {
    fixture
      .givenNoPriorActivity()
      .`when`(CreateTeam(name = "Muppet Team", id = "4712", imageUrl=""))
      .expectEvents(TeamCreated(id = "4712", name = "Muppet Team", team = Team(UserName("Muppet Team_player1"), UserName("Muppet Team_player2")), imageUrl=""))
  }

  @Test
  fun `when a rename team command is received, a team is renamed`() {
    fixture
      .given(TeamCreated(id = "4711", name = "Muppet Team", team = Team(UserName("kermit"), UserName("piggy")), imageUrl=""))
